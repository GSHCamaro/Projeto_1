...
#include <ctime>     // Biblioteca para manipular tempo (usada para gerar números aleatórios)
#include "Sala.cpp"  // Inclusão da classe "Sala" e seus componentes
...
int main() {
    ...
    // Loop para simular 1440 atualizações (representando cada minuto de um dia)
    for (int i = 0; i < 1440; i++) {
        ...
        sala1.exibirEstado("Flores");  // Exibe o estado da sala 1
        ...
        sala2.exibirEstado("Hortalicas");  // Exibe o estado da sala 2
        cout << endl;  // Pula uma linha
        ...
        sala3.exibirEstado("Legumes");  // Exibe o estado da sala 3
